...
function toggleVariation() {
	var box = document.getElementById("variation");
	for(var i=0; i < box.options.length; i++) {
		cssRule(".biblehtmlcontent.biblehtmlcontent .var-"+box.options[i].value).style.display="none";
	}
	cssRule(".biblehtmlcontent.biblehtmlcontent .var-"+box.value).style.display="inline";
}
...
function showNavbar(book, chapter) {
	...
	if (book != "" && document.getElementById("verses")) {
		...
		if (document.getElementsByClassName && document.getElementsByClassName("var").length > 0) {
			html += " &ndash; Gottesnamen: <select style=\"background-color: yellow\" id=\"variation\" onchange=\"toggleVariation()\"><option value=\"default\">gemischt</option><option value=\"var1\">יהוה</option><option value=\"var2\">JHWH</option><option value=\"var3\">Jahwe</option><option value=\"var4\">Jaho</option><option value=\"var5\">Gott</option><option value=\"var6\">der Herr</option><option value=\"var7\">der Ewige</option><option value=\"var8\">Ich/Du/Er</option><option value=\"var9\">Ich-Bin-Da</option><option value=\"var10\">Unser/Euer Gott</option><option value=\"var11\">Unser/Euer Herr</option><option value=\"var12\">Adonai</option><option value=\"var13\">Ha-Schem</option></select>";
		}
